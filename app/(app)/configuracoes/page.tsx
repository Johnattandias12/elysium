...
import { LogOut, User, Camera, ExternalLink, ChevronRight, FolderOpen } from 'lucide-react'
  ...
  return (
    <div className="space-y-5 page-enter">
      ...
      <div className="rounded-2xl p-5"
        style={{ background:'linear-gradient(160deg,rgba(201,168,76,0.05) 0%,rgba(255,255,255,0.01) 100%)', border:'1px solid #1e1e1e' }}>
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            <button onClick={() => fileRef.current?.click()}
              ...
              style={{ background:'#C9A84C', border:'2px solid #080808' }}>
            ...
            {editNome ? (
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 h-8 rounded-lg px-2 text-[#e0e0e0] placeholder-[#2a2a2a] outline-none text-sm"
              ...
              <button onClick={() => { setEditNome(true); setNomeInput(nome) }}
                ...
                <p className="text-[#e0e0e0] font-semibold flex items-center gap-1.5">
                  {displayName}
                  <span className="text-[10px] text-[#2a2a2a] group-hover:text-[#555] transition-colors">✏️</span>
                </p>
              </button>
            )}
      ...
      <a href="https://mamon-azure.vercel.app/" target="_blank" rel="noopener noreferrer"
        ...
        <div className="flex-1">
          ...
          <p className="text-[#333] text-xs">Gestão financeira avançada</p>
        </div>
      ...
      <Link href="/projetos"
        ...
        <div className="flex-1">
          ...
          <p className="text-[#333] text-xs">Ver todos os sistemas Beyonder</p>
        </div>
        <ChevronRight size={15} className="text-[#2a2a2a]" />
      </Link>

      {/* perfil / conta */}
      <div className="rounded-2xl divide-y divide-[#1a1a1a]"
        style={{ background:'rgba(255,255,255,0.02)', border:'1px solid #1e1e1e' }}>
        <button className="flex items-center gap-3 w-full px-4 py-4 active:bg-[#111] transition-colors text-left">
          ...
          <div className="flex-1">
            ...
            <p className="text-[#333] text-xs">Dados e autenticação</p>
          </div>
